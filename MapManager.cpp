...
void MapManager::Init()
{
	...
	maps.push_back(new Map(L"È¸ÀıÀÇ È¸¶û(º¸¶ó)", Vec2(0.f, -2000.f), Vec2(1920, 1265), *AssetManager::GetInstance().LoadTexture(L"BossWill_Phase1_pupple_background", L"BossWill_Phase1_pupple_background.png"), Vec2(0.f, 155.f)));
}
